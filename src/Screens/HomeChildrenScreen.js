  ...
  return (
    ...
    <Box flex={1} bg={Colors.subGreen}>
        ...
        <ScrollView flex={1} showsVerticalScrollIndicator={false}>
            ...
            <Heading fontWeight="extrabold" color={Colors.main} fontSize={20} mb={2} mt={2} alignSelf="center">
                    NIÑO
            </Heading>
            <Flex flexWrap="wrap"
                direction="row"
                ...
                {products.infantil.slice(0,10).map((product) => (
                        <Pressable
            ...
            <Flex flexWrap="wrap"
                ...
                {products.infantil.slice(10,21).map((product) => (
                        <Pressable
                            onPress={() => navigation.navigate("Single", product)}
                            key={product._id}
                            width="47%"
...
export default HomeChildrenProducts;